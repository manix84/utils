...
define('utils/date', [
    ...
    var date = {
         ...
         */
        getMonthShort: function (dateValue, convert) {

            var month = dateValue;
            if (!!convert || (!isNaN(month) && month > 12)) {
                month = this.convertToDate(dateValue).getMonth();
            }
         ...
         * @param {date object|number} dateValue - Date class|Day 1-12.  If not set, it assumes you mean 'now'.
         * @param {boolean} [convert] - does the value being sent needs to be converted to a date.
         * @return {string} "January"
         */
        getMonthFull: function (dateValue, convert) {
