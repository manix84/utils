 ...
 *
 * @exports utils/date/format
 * @requires utils/core
 * @requires utils/date
 */
define('utils/date/format', [
    'utils/core',
    'utils/date'
], function (utilsBase, date) {
        /**
         ...
         */
        var format = function (mask, dateValue) {
            var maskArray = '',
            ...
            for (i in maskArray) {
                if (maskArray.hasOwnProperty(i)) {
                     ...
                     */
                    case 'd':
                        o += date._padZero(dateValue.getDate());
                        break;
                     ...
                     */
                    case 'D':
                        o += date.getDayShort(dateValue.getDay());
                        break;
                     ...
                     */
                    case 'l':
                        o += date.getDayFull(dateValue.getDay());
                        break;
                     ...
                     */
                    case 'S':
                        o += date.getDayOrdinal(dateValue.getDate());
                        break;
                     ...
                     */
                    case 'F':
                        o += date.getMonthFull(dateValue.getMonth());
                        break;
                     ...
                     */
                    case 'm':
                        o += date._padZero(dateValue.getMonth() + 1);
                        break;
                     ...
                     */
                    case 'M':
                        o += date.getMonthShort(dateValue.getMonth());
                        break;
                     ...
                     */
                    case 'y':
                        o += date.getYearShort(dateValue.getFullYear());
                        break;
                     ...
                     */
                    case 'a':
                        o += date.getHourPostfix(dateValue.getHours());
                        break;
                     ...
                     */
                    case 'A':
                        o += date.getHourPostfix(dateValue.getHours()).toUpperCase();
                        break;
                     ...
                     */
                    case 'B':
                        o += Math.floor(date.getBeatTime(dateValue));
                        break;
                     ...
                     */
                    case 'g':
                        o += date.get12Hours(dateValue.getHours());
                        break;
                     ...
                     */
                    case 'h':
                        o += date._padZero(date.get12Hours(dateValue.getHours()));
                        break;
                     ...
                     */
                    case 'H':
                        o += date._padZero(dateValue.getHours());
                        break;
                     ...
                     */
                    case 'i':
                        o += date._padZero(dateValue.getMinutes());
                        break;
                     ...
                     */
                    case 's':
                        o += date._padZero(dateValue.getSeconds());
                        break;
                     ...
                     */
                    case 'u':
                        o += date._padZero(dateValue.getMilliseconds(), 3);
                        break;
                     ...
                     */
                    case 'I':
                        o += date.getDSTIdentifier(dateValue);
                        break;
                     ...
                     */
                    case 'O':
                        o += date.getReadableTimezone(dateValue, false);
                        break;
                     ...
                     */
                    case 'P':
                        o += date.getReadableTimezone(dateValue, true);
                        break;
                     ...
                     */
                    case 'c':
                        o += date.convertToIso8601(dateValue);
                        break;
                     ...
                     */
                    case 'r':
                        o += date.convertToRFC2822(dateValue);
                        break;
                     ...
                     */
                    case 'U':
                        o += date.convertToTimestamp(dateValue);
                        break;
